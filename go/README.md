...
```bash
go get github.com/fmind/fgraph/go@v1.0.2
```
...
The module lives in the `go/` subdirectory, so maintainers publish version `v1.0.2` with the repository tag `go/v1.0.2`.
